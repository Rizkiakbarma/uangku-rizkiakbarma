...
export default function App() {
  ...
  // 🔥 PERHITUNGAN ZAKAT BARU (Dynamic Assets)
            ...
            {activeTab === 'zakat' && (
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-6 max-w-6xl mx-auto">
                ...
                <div className={`p-8 lg:p-10 rounded-[2.5rem] ${t.darkCardBg} text-white shadow-xl relative overflow-hidden group`}>
                  ...
                  <div className="relative z-10 w-full">
                    <Title className={`font-bold uppercase tracking-[0.3em] text-[10px] mb-3 border-l-4 pl-3 ${t.accentDark} border-current`}>Kalkulator Zakat Komprehensif</Title>
                    <h2 className="text-3xl lg:text-4xl font-black tracking-tighter mb-2">Tunaikan Kewajibanmu 🕌</h2>
                    <Text className="text-white/60 text-xs font-medium max-w-xl">Hitung estimasi zakat maal dari total kekayaan bersihmu (Saldo Aplikasi + Tabungan Luar + Emas) dikurangi Utang Jatuh Tempo.</Text>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                  ...
                  <div className="lg:col-span-7 space-y-6">
                    <Card className={`rounded-[2.5rem] border-none shadow-sm ring-1 p-8 ${t.cardBg} ${t.border}`}>
                      ...
                      <div className="space-y-5">
                        ...
                        <div>
                          <label className={`block text-[10px] font-bold uppercase tracking-widest mb-2 ${t.textSub}`}>Saldo Utama (Dari Aplikasi)</label>
                        ...
                        {/* Tabungan Lain / Tunai */}
                        <div>
                          <label className={`block text-[10px] font-bold uppercase tracking-widest mb-2 ${t.textSub}`}>Uang Tunai / Tabungan Bank Lain</label>
                        ...
                        {/* Emas / Perak */}
                        <div>
                          <label className={`block text-[10px] font-bold uppercase tracking-widest mb-2 ${t.textSub}`}>Nilai Emas / Perak / Perhiasan</label>
                          <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                              <span className={`font-bold ${t.textSub}`}>Rp</span>
                            </div>
                        ...
                        <div className="pt-4 border-t border-dashed border-slate-200">
                          <label className={`block text-[10px] font-bold uppercase tracking-widest mb-2 text-rose-500`}>Utang Jatuh Tempo (Pengurang Harta)</label>
                          <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                          ...
                          <p className={`text-[9px] mt-2 italic ${t.textSub}`}>*Hanya masukkan utang yang wajib dilunasi dalam waktu dekat.</p>
                        </div>
                      </div>
                    </Card>
                  </div>

                  {/* KOLOM KANAN: HASIL & INFO NISHAB */}
                  <div className="lg:col-span-5 space-y-6">
                    ...
                    <Card className={`rounded-[3rem] p-8 lg:p-10 bg-gradient-to-br ${t.primaryGradient} text-white shadow-xl relative overflow-hidden group border border-white/10`}>
                      <div className="absolute -top-20 -right-20 w-[20rem] h-[20rem] bg-white/10 rounded-full blur-[80px] group-hover:scale-110 transition-transform duration-1000"></div>
                      <div className="relative z-10 text-center">
                          <div className="w-16 h-16 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center mx-auto mb-6 border border-white/20 shadow-lg"><Calculator className="text-white w-8 h-8" strokeWidth={2.5}/></div>
                          <Text className="text-white/80 font-bold uppercase tracking-[0.3em] text-[10px] mb-2 leading-none">Kewajiban Zakat Maal (2.5%)</Text>
                          <Metric className="text-white font-black text-4xl lg:text-5xl mt-4 tracking-tighter drop-shadow-xl">{formatRp(zakatToPay)}</Metric>
                          ...
                          <div className="mt-8 bg-black/20 p-5 rounded-2xl border border-white/10 text-left backdrop-blur-sm">
                            ...
                            <ProgressBar value={progressNishab} color={t.chartMain} className="h-2 rounded-full bg-black/40" />
                          </div>
                    ...
                    {/* Kartu Informasi & Pengaturan Emas */}
                    <Card className={`rounded-[2rem] border-none shadow-sm ring-1 p-6 ${t.cardBg} ${t.border}`}>
                      ...
                      <div className="space-y-4">
                        <div>
                          <label className={`block text-[10px] font-bold uppercase tracking-widest mb-1.5 ${t.textSub}`}>Harga Emas Saat Ini (Per Gram)</label>
                          <div className="relative">
                          ...
                          <p className={`text-[9px] mt-1.5 italic ${t.textSub}`}>*Standar nishab zakat maal adalah 85 gram emas murni.</p>
                        </div>
                      </div>
                    </Card>
                  </div>
